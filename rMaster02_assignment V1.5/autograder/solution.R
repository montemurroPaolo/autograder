...
blackScholesCall_sol <- function (S,K,t,r,sigma)
...
dcinterest_simple <- function(r,t) 
  # INCORRECT VERSION, does not use fractional years correctly.
  # INPUT	  r	1x1 .. interest rate [fractions of 1]
  #         t	1x1 .. duration in yrs
  # OUTPUT y  1x1 .. payoff
  # USAGE   dcinterest(r,t) 
  # peter.gruber@usi.ch, 2011-09-01
{
  y <- (1+r)^t       # Amount after tFull years
  return(y)
}
